<script>
    $(document).ready(function () {
        if (sessionStorage.getItem('commodity')) {
            var commodity = JSON.parse(sessionStorage.getItem('commodity'));
    ...
    function queryCommodityInfo(e) {
        location.href = "/airflow.php/commodity/info?id=" + $(e).attr('data-id');
    }
</script>
