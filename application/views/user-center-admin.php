...
<div class="ui basic modal" id="pay-modal" style="text-align: center">
    <div class="ui icon header">
        <i class="shop icon"></i>
        支付
    </div>
...
<div class="ui grid divided container">
    <div class="ui four wide column">
        ...
        <div class="ui secondary fluid vertical pointing menu">
            <a class="active item" data-func="todo-list" onclick="updateTodoList()">
                待办事项
            </a>
            <a class="item" data-func="upload-commodity">
                商品上架
            </a>
    ...
    <div class="ui container twelve wide column" id="func-area" style="padding: 3%">
        ...
        <div id="upload-commodity" style="display: none">
            <h2 class="ui header">
                商品上架
            </h2>
