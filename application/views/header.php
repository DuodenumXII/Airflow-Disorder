...
//                        refreshNavBar();
        ...
        function updateUserAvatar() {
            ...
            $('#avatar').attr('src', user.user.user_icon);
            $('#user-name').html(user.user.user_name);
        }
    </script>
</head>
<body>
...
<!--                            <input class="" type="text" name="name" placeholder="账号">-->
...
<!--                            <div class="column">-->
<!--                                <div class="ui fluid purple inverted button">登陆</div>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
